	...
	<div class="container" style="height: 132px;">
		<header class="header" class="py-5 mt-5">
			<nav class="navbar navbar-expand-lg fixed-top py-3">
				<div class="container">
					<img alt="logo" src="./images/logo2.png" height="100px">
						...
						%>
        					...
        					<div class="item">
        						<div class="animate-box"> 
					        		...
					        		<!-- VIEW MORE DETAILS -->
					        		<a target="_blank" href="Gallery_singlePainting_NotLogged.jsp?painting_id=<%= rs.getInt("painting_id")%>&artistName=<%=rs.getString("a.name")%>" style = "text-align:right; margin: 5px 10px 5px 5px;font-size:13px;"> View more details </a>
