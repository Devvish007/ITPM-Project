...
<div class="container p-3 my-3 rounded col-md-4" style="background-color: #cfd0d1;">
	...
	<div style="float:;">
		<div class="form__group">
			...
			<input type="text" id="artworkTitle" name="artworkTitle" placeholder="Enter Title of the Artwork here" required
				oninvalid="this.setCustomValidity('Enter Title Here')" oninvalid= "alert('Please enter the Title');"
	  			oninput="this.setCustomValidity('')" class="form__input"><br/>
		</div>
		<div class="form__group">
		...
		<div class="form__group">
			<label style="float: left">Price (LKR)</label><br> 
 ...
 !!this.value && Math.abs(this.value) >= 0 ? Math.abs(this.value) : null" step=".01" placeholder="Enter Price of the Artwork here" >
		...
		<div class="form__group">
			...
			<!-- 
			<input type="text" id="artworkCategory" name="artworkCategory" placeholder="Category of the Artwork">
			 -->
